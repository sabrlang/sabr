...
typedef enum sabr_interpreter_op_errcode_enum {
	SABR_OPERR_NONE, // 에러 미발생
	SABR_OPERR_STACK, // 스택 오버플로우
	SABR_OPERR_RUNTIME, // 런타임 에러
	SABR_OPERR_REDEFINE, // 재정의
	SABR_OPERR_UNDEFINED, // 미정의
	SABR_OPERR_INVALID_IDENT, // 올바르지 않은 식별자
	SABR_OPERR_DIV_BY_ZERO, // 0으로 나누기
	SABR_OPERR_IO, // 입출력
	SABR_OPERR_UNICODE,
	SABR_OPERR_MEMORY,
	SABR_OPERR_WHAT
